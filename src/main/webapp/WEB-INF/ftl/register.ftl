...
<div class="container ">
    <nav class="navbar navbar-light bg-white shadow">
        <ul class="nav">
            <li class="nav-item">
                <a href="/">
                    <img src="https://m.imooc.com/static/wap/static/common/img/logo2.png"
                         referrer="no-referrer|origin|unsafe-url" class="mt-1"
                         style="width: 100px">
                </a>
            </li>
        </ul>
            ...
            <div class="passport bg-white">
                ...
                <div class="input-group mt-4 ">
                    ...
                    <div class="col-4 p-0 pl-2 pt-0">
                        <!-- 验证码图片 -->
                        <img id="imgVerifyCode" referrer="no-referrer|origin|unsafe-url" src="/verify_code"
