...
<head>
    ...
    <script>
        ...
        $(function () {
            <#if memberReadState ??>
            // console.log(memberReadState.readState)
            ...
            <li class="nav-item">
                <a href="/">
                    <img referrer="no-referrer|origin|unsafe-url"
                         src="https://m.imooc.com/static/wap/static/common/img/logo2.png" class="mt-1"
                         style="width: 100px">
                </a>
            </li>
    ...
    <div class="container mt-2 p-2 m-0" style="background-color:rgb(127, 125, 121)">
        <div class="row">
            <div class="col-4 mb-2 pl-0 pr-0">
                <img style="width: 110px;height: 160px" referrer="no-referrer|origin|unsafe-url"
                     src="${book.cover}">
            </div>
                ...
                <div class="row pl-1 pr-2">
                    <div class="col-6 p-1">
                        <button type="button" data-read-state="1" class="btn btn-light btn-sm w-100">
                            <img style="width: 1rem;" class="mr-1" referrer="no-referrer|origin|unsafe-url"
            ...
            <div>
                <div>
                    ...
                    <button type="button" data-evaluation-id="${evaluation.evaluationId}"
                        ...
                        <img style="width: 24px;margin-top: -5px;" class="mr-1" referrer="no-referrer|origin|unsafe-url"
